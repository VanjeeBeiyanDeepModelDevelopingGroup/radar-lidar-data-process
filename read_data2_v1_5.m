...
% 2022-07-29: 测试版本，仅仅可视化毫米波雷达数据

function read_data2_v1_5
clear
close all
...
%         frameNum = length(lidar_dir_struct);
        frameNum = length(radar_dir_struct);
        timestampShift = 5;
...
%                                 mmwaveResults_urrsrrNormal_applied(radarDataAll, vel1data, vel2data,lidarDataFrame_singL, num2str(1),lineId);
                                mmwaveResults_urrsrrNormal_applied(radarDataAll, vel1data, vel2data,num2str(1));
%                                 startNum = 40;
