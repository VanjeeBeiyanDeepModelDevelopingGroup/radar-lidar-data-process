...
%%% and Mmwave Studio
function [cpdata, vel1data, vel2data] = read3DCA1000(fileName, numADCSamples, numADCSamples_vel, numChirps_cp, numChirps_vel1, numChirps_vel2, RX_num, TX_num, frame_num)
%% read file
% read .bin file
