...
for frame_number=1:radar_cube_struct.dim.numFrames
    ...
    angle_reso_fft=60;
    angle_reso_bin_fft = 180/angle_reso_fft;
    angle_coor_fft = asin((-90:angle_reso_bin_fft:90-1)/90)/pi*180;
    %% 天线通道相位校准
    ...
    [bi_rangefft] = cfar_ca1D_square(range_fft,15,6,range_cfar_thresh,0);
    ...
    range_doppler_img = 20*log2(abs(squeeze(range_doppler_radarcube)));
    ...
    new_radar_cube_all = zeros(radar_cube_struct.rfParams.numDopplerBins,angle_reso_fft,radar_cube_struct.rfParams.numRangeBins);
